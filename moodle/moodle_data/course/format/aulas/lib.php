...
class format_aulas extends format_topics 
{
    ...
    public function course_format_options($foreditform = false){
        ...
        if ($courseformatoptions === false) {
            ...
            $courseformatoptions['showdefaultsectionname'] = array(
                'default' => get_config('format_aulas', 'showdefaultsectionname'),
                'type' => PARAM_INT,
            );
            // $courseformatoptions['Modulevideohome'] = array(
            //     'default' => get_config('format_aulas', 'Modulevideohome'),
            //     'type' => PARAM_TEXT,
            // );
            $courseformatoptions['MainObjective'] = array(
                'default' => get_config('format_aulas', 'MainObjective'),
                'type' => PARAM_TEXT,
            );
            
            
            for ($i = 1; $i <= 4; $i++) {
                $divisortext = get_config('format_aulas', 'moduletitle'.$i);
                $divisortextvideo = get_config('format_aulas', 'modulevideo'.$i);
                $divisortextobj = get_config('format_aulas', 'moduleobjetive'.$i);
                $divisorname = get_config('format_aulas', 'modulename'.$i);
                if (!$divisortext) {
                    $divisortext = '';
                    $divisortextrule = '';
                    $divisorname = '';
            ...
            //     'label' => get_string('moduleimg', 'format_aulas'),
            //     'help' => 'moduleimg',
            //     'help_component' => 'format_aulas',
            ...
            //     file_prepare_draft_area($draftid_editor_file, $context->id, 'format_aulas', 'images', $i, $optionsfile);
        ...
        if ($foreditform && !isset($courseformatoptions['coursedisplay']['label'])) {
            ...
            $courseformatoptionsedit['numsections'] = array(
                'label' => get_string('numsections', 'format_aulas'),
                'element_type' => 'select',
            ...
            $courseformatoptionsedit['showdefaultsectionname'] = array(
                'label' => get_string('showdefaultsectionname', 'format_aulas'),
                'help' => 'showdefaultsectionname',
                'help_component' => 'format_aulas',
                'element_type' => 'select',
                'element_attributes' => array(
                    array(
                        1 => get_string('yes', 'format_aulas'),
                        0 => get_string('no', 'format_aulas'),
                    ),
                ),
            );
            // $courseformatoptionsedit['Modulevideohome'] = array(
            //     'label' => get_string('Modulevideohome', 'format_aulas'),
            //     'help' => 'Modulevideohome',
            //     'help_component' => 'format_aulas',
            //     'element_type' => 'text',
            // );
            $courseformatoptionsedit['MainObjective'] = array(
                'label' => get_string('MainObjective', 'format_aulas'),
                'help' => 'MainObjective',
                'help_component' => 'format_aulas',
                'element_type' => 'text',
            );
            for ($i = 1; $i <= 4; $i++) {
                ...
                $courseformatoptionsedit['moduletitle'.$i] = array(
                    'label' => get_string('moduletitle', 'format_aulas', $i),
                    'help' => 'moduletitle',
                    'help_component' => 'format_aulas',
                    'element_type' => 'text',
                ...
                $courseformatoptionsedit['modulename'.$i] = array(
                    'label' => get_string('modulename', 'format_aulas', $i),
                    'help' => 'modulename',
                    'help_component' => 'format_aulas',
                    'element_type' => 'text',
                ); 
                ...
                //     'label' => get_string('modulevideo', 'format_aulas', $i),
                //     'help' => 'modulevideo',
                //     'help_component' => 'format_aulas',
                //     'element_type' => 'text',
                // );
                // $courseformatoptionsedit['moduleobjetive'.$i] = array(
                //     'label' => get_string('moduleobjetive', 'format_aulas', $i),
                //     'help' => 'moduleobjetive',
                //     'help_component' => 'format_aulas',
                //     'element_type' => 'text',
                // );
    ...
    //             $entry = file_save_draft_area_files($draftitemid, $context->id, 'format_aulas', 'images', $i, $filesoptions);
 ...
 */
function format_aulas_inplace_editable($itemtype, $itemid, $newvalue){
 ...
 */
// function format_aulas_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options=array()) {
...
//     $fs = get_file_storage();
//     $file = $fs->get_file($context->id, 'format_aulas', $filearea, $itemid, $filepath, $filename);
//     if (!$file) {
 ...
 */
 ...
 function progress_percentage_aulas($courseid) {
    global $DB;
    $activities = array();
    //get the id of all section
 ...
 */
function activities_aulas($course,$section,$user) {
    global $DB; 
    $completecount = 0;
    $complete_act = 0;
