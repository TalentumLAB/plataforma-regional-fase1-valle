 ...
 *
 * @module     theme_aulas_valle/drawers
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_aulas_valle/drawers:show}
     * @property {String} drawerShown See {@link event:theme_aulas_valle/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_aulas_valle/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_aulas_valle/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_aulas_valle/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_aulas_valle/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_aulas_valle/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_aulas_valle/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_aulas_valle/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_aulas_valle/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_aulas_valle/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_aulas_valle/drawers:hidden',
    };
     ...
     * @returns {module:theme_aulas_valle/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_aulas_valle/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_aulas_valle/drawers:close');
     ...
     *
     * @param {module:theme_aulas_valle/drawers} comparisonInstance
     */
