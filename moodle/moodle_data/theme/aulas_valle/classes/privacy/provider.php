...
/**
 * Privacy Subsystem implementation for theme_aulas_valle.
 *
...
namespace theme_aulas_valle\privacy;
...
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:drawernavclosed', 'theme_aulas_valle');
            if ($draweropennavpref == 'true') {
                $preferencestring = get_string('privacy:drawernavopen', 'theme_aulas_valle');
            }
        ...
        if (isset($draweropenindexpref)) {
            $preferencestring = get_string('privacy:drawerindexclosed', 'theme_aulas_valle');
            if ($draweropenindexpref == 1) {
                $preferencestring = get_string('privacy:drawerindexopen', 'theme_aulas_valle');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_aulas_valle',
        ...
        if (isset($draweropenblockpref)) {
            $preferencestring = get_string('privacy:drawerblockclosed', 'theme_aulas_valle');
            if ($draweropenblockpref == 1) {
                $preferencestring = get_string('privacy:drawerblockopen', 'theme_aulas_valle');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_aulas_valle',
