...
$iscourseinternal = '';
if($courseid != 1){
    $iscourse = 'aulas_valle-course-bg-image';
    $iscourseinternal = 'taletum-course-internal';
}else{
    $iscourse = 'aulas_valle-no-course-bg-image';
}

$img = $OUTPUT->image_url('logos_footer', 'theme');
$img_course = $OUTPUT->image_url('BANNER-SUPERIOR', 'theme');
...
echo $OUTPUT->render_from_template('theme_aulas_valle/drawers', $templatecontext);
