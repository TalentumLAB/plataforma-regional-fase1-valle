...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_talentum/drawers:show}
     * @property {String} drawerShown See {@link event:theme_talentum/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_talentum/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_talentum/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_talentum/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_talentum/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_talentum/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_talentum/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_talentum/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_talentum/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_talentum/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_talentum/drawers:hidden',
    };
     ...
     * @returns {module:theme_talentum/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_talentum/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_talentum/drawers:close');
     ...
     *
     * @param {module:theme_talentum/drawers} comparisonInstance
     */
